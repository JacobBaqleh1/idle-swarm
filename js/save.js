...
const DEFAULT_STATE = {
  ...
  units: {
    larva:       { count: 0, purchased: 0, unlocked: true,  visible: true  },
    ant:         { count: 0, purchased: 0, unlocked: false, visible: false },
    queen:       { count: 0, purchased: 0, unlocked: false, visible: false },
    miner:       { count: 0, purchased: 0, unlocked: false, visible: false },
    scientist:   { count: 0, purchased: 0, unlocked: false, visible: false },
    farmer:      { count: 0, purchased: 0, unlocked: false, visible: false },
    carpenter:   { count: 0, purchased: 0, unlocked: false, visible: false },
    grasscutter: { count: 0, purchased: 0, unlocked: false, visible: false },
    aphid:       { count: 0, purchased: 0, unlocked: false, visible: false },
  },
  delveUpgrades: {
